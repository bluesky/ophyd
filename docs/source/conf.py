...
latex_documents = [
    ("index", "ophyd.tex", "ophyd Documentation", "Brookhaven National Lab", "manual"),
]
...
man_pages = [("index", "ophyd", "ophyd Documentation", ["Brookhaven National Lab"], 1)]
