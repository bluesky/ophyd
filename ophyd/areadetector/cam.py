...
class PICamDetectorCam(CamBase):
    ...
    phosphor_decay_delay_resolution_ex = ADCpt(EpicsSignal, 'PhosphorDecayDelayResolution_EX')
    ...
    clean_section_final_height_count_ex = ADCpt(EpicsSignal, 'CleanSectionFinalHeightCount_EX')
    ...
    phosphor_decay_delay_resolution_pr = ADCpt(EpicsSignal, 'PhosphorDecayDelayResolution_PR')
    ...
    clean_section_final_height_count_pr = ADCpt(EpicsSignal, 'CleanSectionFinalHeightCount_PR')
    ...
    phosphor_decay_delay_resolution = ADCpt(SignalWithRBV, 'PhosphorDecayDelayResolution')
    ...
    enable_modulation_output_signal = ADCpt(SignalWithRBV, 'EnableModulationOutputSignal')
    modulation_output_signal_frequency = ADCpt(SignalWithRBV, 'ModulationOutputSignalFrequency')
    modulation_output_signal_amplitude = ADCpt(SignalWithRBV, 'ModulationOutputSignalAmplitude')
    ...
    clean_section_final_height_count = ADCpt(SignalWithRBV, 'CleanSectionFinalHeightCount')
