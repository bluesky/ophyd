...
class EpicsDXPGroup(PVGroup):
    ...
    elapsed_trigger_live_time = pvproperty(
        name='ElapsedTriggerLiveTime', dtype=unknown)
    trigger_peaking_time = pvproperty_with_rbv(
        name='TriggerPeakingTime', dtype=unknown)
    trigger_threshold = pvproperty_with_rbv(
    ...
    energy_threshold = pvproperty_with_rbv(
        name='EnergyThreshold', dtype=unknown)
    gap_time = pvproperty_with_rbv(name='GapTime', dtype=unknown)
    baseline_cut_percent = pvproperty_with_rbv(
        name='BaselineCutPercent', dtype=unknown)
    baseline_cut_enable = pvproperty_with_rbv(
        name='BaselineCutEnable', dtype=unknown)
    baseline_filter_length = pvproperty_with_rbv(
        name='BaselineFilterLength', dtype=unknown)
    baseline_threshold = pvproperty_with_rbv(
        name='BaselineThreshold', dtype=unknown)
    baseline_energy_array = pvproperty(
        name='BaselineEnergyArray', dtype=unknown)
    ...
    detector_polarity = pvproperty_with_rbv(
        name='DetectorPolarity', dtype=unknown)
    ...
    adc_percent_rule = pvproperty_with_rbv(
        name='ADCPercentRule', dtype=unknown)
